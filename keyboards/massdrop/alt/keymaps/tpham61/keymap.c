...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_APP_GL] = ACTION_TAP_DANCE_LAYER_TOGGLE(KC_APP, _GL),
    [TD_CTRL_AL] = ACTION_TAP_DANCE_LAYER_TOGGLE(KC_LCTRL, _AL),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT(
        ...
        _______, _______, TG(_ML), TG(_GL),  _______, _______, _______, _______,  _______,  ROUT_FM, ROUT_TG, ROUT_VD, ROUT_VI, _______, KC_MSTP, KC_MPLY, KC_VOLU,
    ...
    */
    [_KL] = LAYOUT(
        KC_ESC,           KC_1,           KC_2,    KC_3,     KC_4,    KC_5,    KC_6,    KC_7,     KC_8,     KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_DEL,  \
        KC_TAB,           KC_Q,           KC_W,    KC_E,     KC_R,    KC_T,    KC_Y,    KC_U,     KC_I,     KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_HOME, \
        TT(_AL),          KC_A,           KC_S,    KC_D,     KC_F,    KC_G,    KC_H,    KC_J,     KC_K,     KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_PGUP, \
        KC_LSFT,          KC_Z,           KC_X,    KC_C,     KC_V,    KC_B,    KC_N,    KC_M,     KC_COMM,  KC_DOT,  KC_SLSH, KC_RSFT,          KC_UP,   KC_PGDN, \
        KC_LCTL,          TD(TD_LGUI_ML), KC_LALT,                             KC_SPC,                               KC_RALT, TT(_FL), KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
    [_FL] = LAYOUT(
        KC_GRV,           KC_F1,          KC_F2,   KC_F3,    KC_F4,   KC_F5,   KC_F6,   KC_F7,    KC_F8,    KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_MUTE, \
        RGB_MODE_SNAKE,   RGB_SPD,        RGB_VAI, RGB_SPI,  RGB_HUI, RGB_SAI, _______, _______,  _______,  _______, KC_PSCR, _______, _______, _______, _______, \
        KC_CAPS,          RGB_RMOD,       RGB_VAD, RGB_MOD,  RGB_HUD, RGB_SAD, _______, _______,  _______,  _______, _______, _______,          _______, KC_VOLU, \
        RGB_MODE_KNIGHT,  RGB_TOG,        _______, _______,  _______, MD_BOOT, _______, _______,  _______,  _______, _______, _______,          KC_BRIU, KC_VOLD, \
        RGB_MODE_XMAS,    _______,        KC_LALT,                             _______,                              _______, TG(_FL), _______, KC_BRID, _______  \
    ),
    [_ML] = LAYOUT(
        _______,          KC_BTN4,        KC_BTN3, KC_BTN5,  _______, _______, _______, _______,  _______,  _______, _______, _______, _______, _______, _______,
        ...
        _______,          TG(_ML),        _______,                             _______,                              _______, TG(_ML), KC_MS_L, KC_MS_D, KC_MS_R
    ),
    [_GL] = LAYOUT(
        _______,          _______,        _______, _______,  _______, _______, _______, _______,  _______,  _______, _______, _______, _______, _______, _______,
        _______,          _______,        _______, _______,  G_REMTE, G_RESET, G_REBAS, _______,  G_INIT,   _______, G_PULL,  G_PUSH,  _______, _______, _______,
        _______,          G_ADD,          G_STAT,  G_DIFF,   G_FETCH, _______, _______, _______,  _______,  G_LOG,   _______, _______,          _______, _______,
        _______,          G_CONF,         G_CHECK, G_CLONE,  G_COMM,  G_BRANH, _______, G_MERGE,  _______,  _______, _______, _______,          _______, _______,                          
        _______,          _______,        _______,                             _______,                              _______, TG(_GL), _______, _______, _______          
    ),
    [_AL] = LAYOUT(
        _______,          _______,        _______, _______,  _______, _______, _______, _______,  _______,  _______, _______, _______, _______, _______, _______, 
        _______,          _______,        _______, _______,  _______, _______, _______, KC_HOME,  KC_UP,    KC_END,  _______, _______, _______, _______, _______, 
        TG(_AL),          _______,        _______, _______,  _______, _______, _______, KC_LEFT,  KC_DOWN,  KC_RGHT, _______, _______,          _______, _______,
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    [_FL] = {
        PINK,             PINK,           PINK,    PINK,     PINK,    PINK,    PINK,    PINK,     PINK,     PINK,    PINK,    PINK,    PINK,    _______, GOLD,
        _______,          ORANGE,         ORANGE,  ORANGE,   ORANGE,  ORANGE,  _______, _______,  _______,  _______, BLUE,    _______, _______, _______, _______,
        PINK,             ORANGE,         ORANGE,  ORANGE,   ORANGE,  ORANGE,  _______, _______,  _______,  _______, _______, _______,          _______, GOLD,
        _______,          ORANGE,         _______, _______,  _______, AZURE,   _______, _______,  _______,  _______, _______, _______,          SPRING,  GOLD,
        _______,          _______,        _______,                             _______,                              _______, PINK,    _______, SPRING,  _______
    },
    [_ML] = {
        _______,          MAGENT,         MAGENT,  MAGENT,   _______, _______, _______, _______,  _______,  _______, _______, _______, _______, _______, _______,
        _______,          MAGENT,         GOLD,    MAGENT,   GOLD,    _______, _______, _______,  _______,  _______, _______, _______, _______, _______, _______, 
        _______,          GOLD,           GOLD,    GOLD,     GOLD,    _______, _______, _______,  _______,  _______, _______, _______,          _______, _______,
        _______,          _______,        _______, _______,  _______, _______, _______, _______,  _______,  _______, _______, _______,          GOLD,    _______,
        _______,          PINK,           _______,                             _______,                              _______, PINK,    GOLD,    GOLD,    GOLD
    },
    [_GL] = {
        _______,          _______,        _______, _______,  _______, _______, _______, _______,  _______,  _______, _______, _______, _______, _______, _______, 
        _______,          _______,        _______, _______,  BLUE,    AZURE,   AZURE,   _______,  CYAN,     _______, TURQ,    PURPLE,  _______, _______, _______, 
        _______,          CORAL,          GREEN,   GREEN,    TURQ,    _______, _______, _______,  _______,  GREEN,   _______, _______,          _______, _______,
        _______,          CYAN,           CHART,   TURQ,     ORANGE,  CHART,   _______, CHART,    _______,  _______, _______, _______,          _______, _______,
        _______,          _______,        _______,                             _______,                              _______, PINK,    _______, _______, _______
    },
    [_AL] = {
        _______,          _______,        _______, _______,  _______, _______, _______, _______,  _______, _______,  _______, _______, _______, _______, _______, 
        _______,          _______,        _______, _______,  _______, _______, _______, MAGENT ,  CYAN,    MAGENT ,  _______, _______, _______, _______, _______, 
        GOLD,             _______,        _______, _______,  _______, _______, _______, CYAN,     CYAN,    CYAN   ,  _______, _______,          _______, _______,
        _______,          _______,        _______, _______,  _______, _______, _______, _______,  _______, _______,  _______, _______,          _______, _______,
